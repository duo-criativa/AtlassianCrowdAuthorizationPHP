...
class InvalidUserAuthenticationException extends \Exception {

    public function __construct($message = 'Username/password combination for authentication is invalid', $code = null, $previous = null)
    {
